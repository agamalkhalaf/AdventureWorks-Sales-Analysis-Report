...
COUNT(fis.SalesOrderNumber) AS "Total Orders",
...
-- Top 100 customers whose total expenditure exceeds the overall average customer spending
create procedure gettopcustomers
as 
begin
select top 100
firstname +' '+LastName as "full name" , gender , 
format(YearlyIncome,'N0') as "yearly income",TotalChildren,format(sum(salesamount),'N0') as "Total Expenditure"
